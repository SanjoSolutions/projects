...
class DegewoFlatOfferListElement extends _FlatOfferListElement.FlatOfferListElement {
  ...
  async getColdRent() {
    return await (0, _getInnerTextOfChildAsCurrency.getInnerTextOfChildAsCurrency)(this.element, '.price')
  }

  async getSeniorsOnly() {
    const title = await (0, _getInnerTextOfChild.getInnerTextOfChild)(this.element, '.article__title')
