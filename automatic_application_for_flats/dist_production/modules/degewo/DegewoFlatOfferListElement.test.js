...
describe("DegewoFlatOfferListElement", () => {
  describe("getUrl", () => {
    it("returns the url of the flat offer detail page", async () => {
      ...
      await page.goto(
        await (0, _getUrl.getUrl)(
          "/modules/degewo/fixtures/degewo_flat_offer_element.html"
        )
      );
      const flatOfferElement = new _DegewoFlatOfferListElement.DegewoFlatOfferListElement(
        await page.$("article")
      );
  ...
  describe("getSeniorsOnly", () => {
    it("returns true when for seniors only", async () => {
      const element = new _DegewoFlatOfferListElement.DegewoFlatOfferListElement(
        await (0,
        _createSeniorsOnlyFlatOfferElement.createSeniorsOnlyFlatOfferElement)(
          browser
        )
      );
