...
async function fillForm({ page }, contactData) {
  ...
  await type('input[name="tx_mbxrealestate_pi1[visitRequest][firstName]"]', contactData.firstName)
  await type('input[name="tx_mbxrealestate_pi1[visitRequest][lastName]"]', contactData.lastName)
