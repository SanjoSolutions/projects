...
export declare class FunctionBuilder {
    ...
    get https(): {
         ...
         */
        onRequest: (handler: (req: https.Request, resp: express.Response<any>) => void) => import("./cloud-functions").HttpsFunction;
        /**
         * Declares a callable method for clients to call using a Firebase SDK.
         * @param handler A method that takes a data and context and returns a value.
         */
        onCall: (handler: (data: any, context: https.CallableContext) => any) => import("./cloud-functions").TriggerAnnotated & ((req: express.Request<import("express-serve-static-core").ParamsDictionary>, resp: express.Response<any>) => void) & import("./cloud-functions").Runnable<any>;
    };
    get database(): {
        /**
