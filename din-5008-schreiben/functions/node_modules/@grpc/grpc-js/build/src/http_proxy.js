    ...
    return new Promise((resolve, reject) => {
        ...
        request.once('connect', (res, socket, head) => {
            ...
            if (res.statusCode === 200) {
                ...
                logging_1.log(constants_1.LogVerbosity.ERROR, 'Failed to connect to ' + subchannelAddress + ' through proxy ' + PROXY_INFO.address);
                reject();
            }
        });
        request.once('error', (err) => {
            request.removeAllListeners();
            logging_1.log(constants_1.LogVerbosity.ERROR, 'Failed to connect to proxy ' + PROXY_INFO.address);
            reject();
        });
    });
}
