...
!(function (e, t) {
    ...
    E.extend({
      ...
      isPlainObject: function (e) {
        ...
        return (
          ...
          (!(t = r(e)) || ('function' == typeof (n = m.call(t, 'constructor') && t.constructor) && a.call(n) === l))
        )
      },
            ...
            : function (e, t, n) {
                ...
                if (c) {
                  ...
                  if (((u = [m ? c.firstChild : c.lastChild]), m && d)) {
                    ;(p =
                      (s =
                        (r = (i = (o = (a = c)[N] || (a[N] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] ===
                          A && r[1]) && r[2]),
                      (a = s && c.childNodes[s])
                    ...
                    (d &&
                      (p = s =
                        (r = (i = (o = (a = e)[N] || (a[N] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] ===
                          A && r[1]),
                    !1 === p)
                  )
                    while ((a = (++s && a && a[l]) || (p = s = 0) || u.pop()))
                      if (
                        ...
                        ++p &&
                        (d && ((i = (o = a[N] || (a[N] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] = [A, p]),
                        a === e)
                      )
                        break
        ...
        : function (e, t, n) {
            ...
            if (n) {
              ...
              while ((e = e[u]))
                if (1 === e.nodeType || f)
                  if (
                    ((i = (o = e[N] || (e[N] = {}))[e.uniqueID] || (o[e.uniqueID] = {})),
      ...
      for (
        ...
        if ((t = x.relative[e[s].type])) c = [xe(we(c), t)]
          ...
          if ((t = x.filter[e[s].type].apply(null, e[s].matches))[N]) {
            ...
            return Te(
              1 < s && we(c),
              1 < s && be(e.slice(0, s - 1).concat({ value: ' ' === e[s - 2].type ? '*' : '' })).replace(F, '$1'),
              t,
              s < n && Ee(e.slice(s, n)),
              n < r && Ee((e = e.slice(n))),
              n < r && be(e)
    ...
    return (
      ...
      (h = se.tokenize = function (e, t) {
        ...
        while (a) {
          ...
          (n = !1),
          (r = _.exec(a)) &&
            ((n = r.shift()), i.push({ value: n, type: r[0].replace(F, ' ') }), (a = a.slice(n.length))),
          x.filter))
            !(r = Q[o].exec(a)) ||
              (u[o] && !(r = u[o](r))) ||
                        ...
                        ;(t = e && ('object' == typeof e || 'function' == typeof e) && e.then),
                          x(t)
                            ? s
                              ...
                              : (u++, t.call(e, l(u, o, R, s), l(u, o, B, s), l(u, o, R, o.notifyWith)))
  ...
  var se = function (e, t) {
      return (
        'none' === (e = t || e).style.display || ('' === e.style.display && oe(e) && 'none' === E.css(e, 'display'))
      )
    },
    ue = function (e, t, n, r) {
      var i,
        ...
        while ((i = a[t++]) && !s.isPropagationStopped()) {
          ...
          while ((o = i.handlers[n++]) && !s.isImmediatePropagationStopped())
            (s.rnamespace && !1 !== o.namespace && !s.rnamespace.test(o.namespace)) ||
              ((s.handleObj = o),
              (s.data = o.data),
              void 0 !== (r = ((E.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, u)) &&
                !1 === (s.result = r) &&
      ...
      e && e.type
        ? ((this.originalEvent = e),
          ...
          (this.isDefaultPrevented =
            e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? Ee : Ne),
  ...
  E.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (t)
        if (n) for (o = o || ge(e), a = a || ge(c), r = 0, i = o.length; r < i; r++) Ie(o[r], a[r])
        else Ie(e, c)
  ...
  function nt(e, t, n) {
    ...
    return (
      ((!b.boxSizingReliable() && i) || 'auto' === a || (!parseFloat(a) && 'inline' === E.css(e, 'display', !1, r))) &&
        ...
        set: function (e, t, n) {
          ...
          return (
            a &&
              o &&
              (s -= Math.ceil(
                e['offset' + u[0].toUpperCase() + u.slice(1)] - parseFloat(i[u]) - tt(e, u, 'border', !1, i) - 0.5
              )),
            s && (r = ne.exec(t)) && 'px' !== (r[3] || 'px') && ((e.style[u] = t), (t = E.css(e, u))),
            et(0, t, s)
          )
        },
      }
      ...
      attr: function (e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return 'undefined' == typeof e.getAttribute
            ? E.prop(e, t, n)
            : ((1 === o && E.isXMLDoc(e)) ||
                (i = E.attrHooks[t.toLowerCase()] || (E.expr.match.bool.test(t) ? rt : void 0)),
              void 0 !== n
                ? null === n
  ...
  ;(E.param = function (e, t) {
    ...
    (b.createHTMLDocument =
      (((pt = v.implementation.createHTMLDocument('').body).innerHTML = '<form></form><form></form>'),
    ...
    (E.parseHTML = function (e, t, n) {
      return 'string' != typeof e
        ...
        : ('boolean' == typeof t && ((n = t), (t = !1)),
          t ||
            (b.createHTMLDocument
              ? (((r = (t = v.implementation.createHTMLDocument('')).createElement('base')).href = v.location.href),
