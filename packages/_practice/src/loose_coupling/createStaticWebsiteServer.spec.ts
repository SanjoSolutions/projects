...
import { createStaticWebsiteServer, StaticHTTPServer } from './createStaticWebsiteServer'
...
describe('createStaticWebsiteServer', () => {
  ...
  it('serves a static website from a directory', async () => {
    server = await createStaticWebsiteServer(
  ...
  it('serves the up-to-date version of the content in the file', async () => {
    ...
    jest.spyOn(fs, 'watch')
      .mockImplementation((filename: PathLike, options: any, listener?: any) => {
