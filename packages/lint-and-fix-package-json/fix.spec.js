...
describe('fix', () => {
    ...
    it('adds missing homepage field', () => {
        ...
        const packageJSON = {};
        const fixedPackageJSON = fix(packageJSON, packagePath);
        expect(fixedPackageJSON).toHaveProperty('homepage', 'https://github.com/SanjoSolutions/unnamed/tree/main/packages/test');
    });
    ...
    it('sorts fields', () => {
        ...
        const fixedPackageJSON = fix(packageJSON, packagePath);
        expect(Object.entries(fixedPackageJSON)).toEqual(Object.entries({
            name: '@sanjo/tagged-template-literals',
            version: '1.0.1',
            type: 'module',
            description: 'Utility functions for tagged template literals',
...
//# sourceMappingURL=fix.spec.js.map