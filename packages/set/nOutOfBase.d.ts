...
export declare function nOutOfBase<T>(n: number, set: Iterable<T>, cache: Cache<number[][]>, getNextSubSequenceElementStartValue: (subSequence: number[]) => number): Set<Set<T>>;
