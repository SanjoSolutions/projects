...
async function main() {
  ...
  async function loadCubeColors() {
    return normalizeCubeColors(await getValue(cubeColorsStorageKey))
  }

  function normalizeCubeColors(cubeColors) {
    return cubeColors.map((cubeColor) => {
