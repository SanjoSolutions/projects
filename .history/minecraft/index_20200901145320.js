...
const lightnessFieldCanvasWidth = 1
const lightnessFieldCanvasHeight = colorFieldHeight
const colorPickerDialogWidth = 12 + 0.5 + lightnessFieldCanvasWidth
...
lightnessField.width = lightnessFieldWidth
lightnessField.height = lightnessFieldHeight
...
function renderLightnessField() {
  for (let y = lightnessFieldHeight; y >= 0; y--) {
