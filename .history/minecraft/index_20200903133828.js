...
async function main() {
  ...
  directionalLightTarget.position.set(0.5 * planeWidth, 0, 0.5 * planeDepth)
  scene.add(directionalLightTarget)

  const directionalLight = createDirectionalLight(directionalLightTarget)
...
function createDirectionalLight() {
  ...
  directionalLight.position.set(planeWidth - 30, 52.5, planeDepth + 30)
  directionalLight.target.position.set(0.5 * planeWidth + 20, 0, 0.5 * planeDepth + 20)
