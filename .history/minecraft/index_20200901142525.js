...
const colorPickerDialogWidth = 12 // rem
const colorPickerDialogHeight = 12 // rem
...
const width = colorPickerDialogWidth * 16
const height = colorPickerDialogHeight * 16
colorField.width = devicePixelRatio * width
colorField.height = devicePixelRatio * height
colorField.style.width = colorPickerDialogWidth + "rem"
colorField.style.height = colorPickerDialogHeight + "rem"
...
const lightness = document.createElement("canvas")
lightness.classList.add("lightness")
lightness.style.height = colorPickerDialogHeight + "rem"
