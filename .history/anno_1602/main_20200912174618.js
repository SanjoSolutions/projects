...
function updateSelectionStyle() {
  selection.style.width = `${selectedBuilding.width}px`
  selection.style.height = `${selectionBuilding.height}px`
  selection.style.backgroundColor = selectionBuilding.backgroundColor
}
