...
export function createBinaryTreeGraph({ min, max, step, showLabels }) {
  ...
  function calculateViewportBoundingBox() {
    return {
      x: 0, // The x-coordinate of the first left top pixel of the graphics that should be rendered.
      y: 0, // The y-coordinate of the first left top pixel of the graphics that should be rendered.
      width: viewportWidth, // The width of the viewport.
      height: viewportHeight // The height of the viewport.
    }
  }
