...
function render({ canvas, context }, { binaryTreeRendering, viewportBoundingBox, binaryTreeRenderingBoundingBox, zoom }) {
  ...
  context.translate(-viewportBoundingBox.x, -viewportBoundingBox.y)

  const x = viewportBoundingBox.x
  console.log('_', viewportBoundingBox.x - binaryTreeRenderingBoundingBox.x)
...
export function createBinaryTreeGraph({ min, max, step, showLabels }) {
  ...
  console.log('binaryTreeRenderingBoundingBox', binaryTreeRenderingBoundingBox)
  console.log('totalRenderingWidth', totalRenderingWidth)
  console.log('totalRenderingHeight', totalRenderingHeight)
  ...
  console.log('totalRenderingWidth', totalRenderingWidth)
  console.log('viewportBoundingBox.width', viewportBoundingBox.width)
  const vp = {
    x: 0.5 * (viewportBoundingBox.width - totalRenderingWidth),
  ...
  console.log('new viewportBoundingBox', vp)
  setViewportBoundingBox(vp)
