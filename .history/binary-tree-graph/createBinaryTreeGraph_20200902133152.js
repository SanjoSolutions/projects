...
export function createBinaryTreeGraph({ min, max, step }) {
  ...
  function rerenderBinaryTree(binaryTree, { binaryTreeRendering, viewportBoundingBox }) {
  ...
  async function main() {
    ...
    let result = rerenderBinaryTree(
      binaryTree,
      { binaryTreeRendering, viewportBoundingBox }
    )
