...
export function createBinaryTreeGraph({ min, max, step, showLabels }) {
  ...
  function setViewportBoundingBox(newViewportBoundingBox) {
    ...
    console.log('viewportBoundingBox', viewportBoundingBox)
    console.log('center', calculateCenter(viewportBoundingBox))
    if (
  ...
  function calculateCenter(viewport) {
    return {
