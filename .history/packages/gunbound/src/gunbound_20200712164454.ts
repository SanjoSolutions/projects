...
const meterToPixelRatio = 300 // meter to pixel (1 meter equals 10 pixel)
...
animate((ellapsedTime: number) => {
  ...
  const y = initialPoint.y + deltaY + windDeltaY - gravityOfEarth * meterToPixelRatio * passedSeconds
