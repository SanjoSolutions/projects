...
describe("replaceStringValue", () => {
  it('replaces "Login Activity" with "@string/lgn_act"', () => {
    ...
    expect(replaceStringValue(lookUp, "Login Activity")).toEqual(
      "@string/lgn_act",
    )
  })
  ...
  it('replaces "Register Me Too" with "@string/rgst_me"', () => {
    ...
    expect(replaceStringValue(lookUp, "Register Me Too")).toEqual(
      "@string/rgst_me",
    )
  })
  ...
  describe('when the string value starts with "@string/"', () => {
    it("does not replace the string value", () => {
      ...
      expect(replaceStringValue(lookUp, "@string/example")).toEqual(
        "@string/example",
      )
    })
  })
