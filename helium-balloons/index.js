...
;(n.g = (function () {
  ...
  (() => {
    ...
    function e(t) {
      ...
      return i
        ? `hsla(${Math.round(360 * e)}, ${Math.round(100 * n)}%, ${Math.round(100 * o)}%, ${i})`
        : `hsl(${Math.round(360 * e)}, ${Math.round(100 * n)}%, ${Math.round(100 * o)}%)`
    }
    function o() {}
    var i = n(279)
    const r = 23.4375,
      ...
      { canvas: u, context: s } = (function ({
        ...
        ;(n.style.width = `${a}px`), (n.style.height = `${c}px`), (n.width = u * a), (n.height = u * c), r.scale(u, u)
        const s = i(function () {
            ...
            if (o > t || a > i) {
              const { canvas: e, context: u } = (function (t, e, { x: n, y: o, width: i, height: r }) {
                const a = document.createElement('canvas')
                ;(a.width = i - n), (a.height = r - o)
                const c = a.getContext('2d')
                return c.putImageData(e.getImageData(n, o, i, r), 0, 0), { canvas: a, context: c }
    ...
    function h() {
      const n = window.innerWidth,
        ...
        i = { x: t(r, n - 1 - r), y: -29.625, color: e(o), speed: (5, 10, 5 + 6 * Math.random()) }
      f.push(i)
    }
    h(),
      (function (t) {
        ...
        function n() {
          {
            ...
            ;(t => {
              ...
              for (const t of f) d(t)
              for (const e of f)
                (e.y += e.speed * (t / 1e3)), (e.x += (t / 1e3) * 3 * Math.cos(0)), (e.y += (t / 1e3) * 3 * Math.sin(0))
              const e = window.innerWidth,
                n = window.innerHeight,
                o = e + r,
                i = n + a + c
              f = f.filter(({ x: t, y: e }) => -23.4375 <= t && t <= o && -29.625 <= e && e <= i)
            })(t - (e || t)),
              (e = t),
              o()
          }
      ...
      u.addEventListener('mousedown', t => {
        const e = window.innerHeight,
          n = t.offsetX,
          o = e - t.offsetY,
          i = f.findIndex(t => t.x - r <= n && n <= t.x + r && t.y - a <= o && o <= t.y + a)
        ;-1 !== i && (f[i], f.splice(i, 1))
      })
    const l = (function () {
      const t = new Path2D()
      return t.ellipse(0, 0, r, a, 0, 0, 2 * Math.PI), t.moveTo(0, a), t.lineTo(0, 103.6875), t
    })()
    function d({ x: t, y: e, color: n }) {
      ;(s.fillStyle = n),
        (function ({ x: t, y: e }, n) {
          s.save(), window.devicePixelRatio, s.translate(t, e), s.fill(l), s.stroke(l), s.restore()
